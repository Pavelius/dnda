...
{"Дипломатия", {Charisma, Wisdow}, {{TargetNotHostileCreatureNoSelf, 1}, {}, setstate, Turn / 2, {Goodwill}, "%герой одобрил%а предложение."}},
//
...
{"Очистить карманы", {Dexterity, Charisma}, {{TargetNotHostileCreatureNoSelf, 1}, {}, pickpockets, Instant, {}, 0, 25}},
...
{"Азартные игры", {Charisma, Dexterity}, {{TargetNotHostileCreatureNoSelf, 1}, {}, gamble, Instant, {}, 0, {}, 25, failgamble}, {0, 2}},
{"История", {Intellegence, Intellegence}},
{"Лечение", {Wisdow, Intellegence}, {{TargetNotHostileCreatureNoSelf, 1}, {}, healdamage, Instant, {}, "%герой перевязал%а раны.", 5}},
