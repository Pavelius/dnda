...
{"Благословение", "благословения", 8, {}, {{TargetFriendly, Close}, {setstate}, {Blessed, Turn}, "%герой озарил%ась желтым светом."}},
{"Благословить предмет", "благословения", 10, {0, 10}, {{TargetItemMundane}, {bless_item}, {}}},
{"Очаровать персону", "шарма", 13, {}, {{TargetFriendly, Near}, {setstate}, {Charmed, Day}, "Внезапно %герой стал%а вести себя дружелюбно."}},
...
{"Страх", "страха", 5, {}, {{TargetHostile, Near, 2}, {setstate}, {Scared, 5 * Minute}, "%герой запаниковал%а и начал%а бежать.", {}}},
{"Лечение", "лечения", 7, {}, {{TargetFriendly, Close}, {healdamage}, {}, "%герой озарился белым светом.", {1, 8, Magic}}},
{"Опознать предмет", "опознания", 20, {3}, {{TargetItemUnidentified}, {identify}, {}}},
{"Невидимость", "невидимости", 8, {}, {{TargetFriendly, Close}, {setstate}, {Hiding, Hour}, "%герой исчез%ла из виду."}},
{"Свет", "света", 1, {}, {{TargetFriendly, Close}, {setstate}, {Lighted, Hour}, "Вокруг %героя появилось несколько светящихся шариков."}},
{"Волшебный снаряд", "колдовства", 3, {}, {{TargetHostile, Near}, {setdamage}, {}, "Из пальцев %ГЕРОЯ вылетело несколько светящихся шариков.", {2, 8, Magic}}},
...
{"Шокирующая хватка", "электричества", 4, {}, {{TargetHostile, Close}, {setdamage}, {}, "Электрический разряд поразил %героя.", {3, 12, Electricity}}},
{"Усыпление", "усыпления", 5, {}, {{TargetHostile, Near}, {setstate}, {Sleeped, 2 * Minute}, "Внезапно %герой заснул%а.", {}}},
{"Замедлить монстров", "замедления", 7, {}, {{TargetHostile, Near}, {setstate}, {Slowed, 5 * Minute}, "Внезапно %герой стал%а двигаться медленнее.", {}}},
};
