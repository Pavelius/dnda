...
{}};
static manual acrobatic[] = {{Element, "Шанс уклонения", "Все **атаки** по существу уменьшают свой шанс попасть на 1%% на каждые 4 единицы этого навыка и используется вместо стандартных бонусов от ловкости, если у персонажа есть навык акробатики."},
...
{}};
static manual concetration[] = {{Element, "Дополнительная мана", "Существа, имеющие этот навык увеличивают максимум **маны** на 1 еденицу за каждые 5% навыка."},
{}};
...
{}};
static manual weapon_focus[] = {{Element, "Шанс попадания", "Если вы сражаетесь с оружием, на которое распространяется данный навык, вы получаете +1% к шансу попасть по врагу за каждые 5 единиц навыка."},
{Element, "Дополнительный урон", "Если вы сражаетесь с оружием, на которое распространяется данный навык, вы получаете +1 к максимальному урону за каждые 30 единиц навыка."},
{}};
