...
{}};
static manual wisdow[] = {{Element, "Дополнительная мана", "максимум **маны** увеличивается на Мудрость/2. Чтобы увеличить еще больше необходим навык **Концентрация**."},
{}};
static manual charisma[] = {
	{}};
static manual item_states[] = {{Element, "Обычные", "предметы которые встречаются чаще всего везде и повсюду. Имеют обычное **качество**, ломаются и разрушаются обычным образом."},
{Element, "Проклятые", "некоторые предметы прокляты богами или злыми колдунами. Их **качество** на единицу выше, но приносят абсолютно противоположный эффект. Они могут ломаться, но их нельзя разрушить."},
{Element, "Благословенные", "предметы, которые носят в себе благословение богов. Их **качество** на единицу выше, они могут ломаться, но их нельзя разрушить."},
{Element, "Реликты", "предметы огромной мощи и значения. Их **качество** на две единицы выше, они не ломаются и их нельзя разрушить, но шанс их появления крайне низкий."},
{}};
...
{Element, "Выбить дверь", "В подземелье часто встречаются заклинившие или закрытые двери. Шанс разнести их в щепки равен навыку атлетика со штрафом в [--20%%]."},
{}};
static manual backstabing[] = {{Element, "Шанс убить", "Попытка нанести атаку внезапно получает +1%% к атаке за каждые [++2%%]. За каждые [++30%%] вы увеличиваете максимальный урон в два раза (вплоть до x4 на [+90%%])."},
{}};
static manual bargain[] = {{Element, "Скидка", "Удачный тест против навыка продавца дает скидку в [+30%%] на покупаемый товар."},
{}};
...
{Header, Backstabbing, "Нанести подлую атаку дружественному существу когда он больше всео этого не ожидает, для того чтобы его убить.", backstabing, skill_procs},
...
{Header, "Состояния предметов", "Каждый предмет может иметь одно ниже перечисленных состояний. Состояния влияют на свойства и качеcтво, а также на то, можно ли предмет уничтожить.", item_states},
{}};
