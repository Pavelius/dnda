...
{}};
static manual backstabing[] = {{Element, "Шанс убить", "Попытка нанести атаку внезапно получает +1%% к атаке за каждые [++2%%]. За каждые [++30%%] вы увеличиваете максимальный урон в два раза (вплоть до x4 на [++91%%])."},
{}};
