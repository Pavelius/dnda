...
{}};
static manual acrobatic[] = {{Element, "Шанс уклонения", "Все **атаки** по существу уменьшают свой шанс попасть на 1%% на каждые [4%%] единицы навыка и используется вместо стандартных бонусов от ловкости, если у персонажа есть навык акробатики (математически выходит то же самое)."},
